...
bool pci_save_vars_funcs_to_file(std::string fname)
{
		...
		save << "# Save file generated by PlusCalc v1.99c\n\n";
...
long double evaluateInput(std::string input, long double ans, bool exitonexception)
{
		...
		else if(input == "license")
		{
		    ...
		    std::cout << "PlusCalc Interpreter v1.99c" << std::endl;
			...
			try
			{
				...
				else if(inputvec[0] == "tmode")
				{
					if(inputvec.size() == 2)
					{
						...
						{
							std::cout << "Info: Valid trigonometry modes are deg, rad, grad, or turn." << std::endl;
							throw syntaxerror;
						}
					}
